...
class Game {
    ...
    isInitialCell(row, col) {
        console.log('>>> isInitialCell called:', { row, col });
        console.log('>>> this.initialSudoku:', this.initialSudoku);
    ...
    /**
     * 猜测一个数字
     * @param {number|Object} row - 行号或 {row, col, value} 对象
    ...
    guess(row, col, value) {
        ...
        console.log('>>> Game.guess parsed:', { rowNum, colNum, valueNum });
